...
Como gestor de estoque do hemocentro, eu quero que o sistema registre automaticamente todos os eventos de uma bolsa (coleta, reserva, transporte, entrega, uso/descarte) para que eu tenha um histórico auditável e confiável de cada hemocomponente.

**Cenários de validação (BDD):**

**Cenário 1:** 
Consulta do histórico da bolsa  
**Dado** que a bolsa já passou por vários status
**Quando** o gestor consulta seu histórico pelo identificador
**Então** o sistema exibe todos os eventos em ordem cronológica, com data/hora e responsável

**Cenário 2:** 
Tentativa de alterar um evento registrado
**Dado** que um evento já está gravado no histórico
**Quando** alguém tenta editá-lo ou excluí-lo
**Então** o sistema bloqueia a operação e mantém o registro original
